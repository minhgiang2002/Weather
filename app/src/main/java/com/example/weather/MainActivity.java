...
public class MainActivity extends AppCompatActivity {
    ...
    public void getCurrentWeatherData(String city) {
        ...
        String url = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=metric&appid=5576e67f17c97aeee91a13e7c2b14ad0";
...
// Lấy đường link đầy đủ
            String iconUrl = "https://openweathermap.org/img/wn/" + icon + ".gif";

// Tải hình ảnh động vào imgIcon bằng Picasso
